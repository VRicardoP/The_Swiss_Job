...
class JSearchProvider(BaseJobProvider):
    ...
    async def fetch_jobs(self, query: str, location: str = "Switzerland") -> list[dict]:
        ...
        params: dict[str, str | int] = {
            "query": query
            or "content editor OR localization specialist OR proofreader OR RLHF OR virtual assistant OR HR coordinator OR instructional designer OR customer success",
            "page": 1,
            "num_pages": 3,
            "country": "ch",
        }
        ...
        raw_jobs = diag.json_items(data, self.API_URL, self.SOURCE_NAME, key="data")
        if not raw_jobs:
            return []
