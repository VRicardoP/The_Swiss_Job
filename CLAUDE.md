...
# Tests core (Fase A/B/C, 338 tests — reconfirmar con pytest tras cada crecida)
...
# Migraciones core (cadena core0001..core0012 — las aplica core-migrate en el arranque)
...
jobhunt_core/       # Core Fase A COMPLETA 2026-07-24 (ensayo GATE A superado): API /v1 FastAPI (core-api :8003),
                    ...
                    #   delivery/runs/profiles, Alembic propio core0001..core0012, tests 338/338 (vía core-migrate)
```
