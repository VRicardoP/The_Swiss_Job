...
# Tests core (Fase A/B/C, 493 tests — reconfirmar con pytest tras cada crecida)
...
jobhunt_core/       # Core Fase A COMPLETA 2026-07-24 (ensayo GATE A superado): API /v1 FastAPI (core-api :8003),
                    ...
                    #   delivery/runs/profiles, Alembic propio core0001..core0023, tests 493/493 (vía core-migrate)
```
