...
# Migraciones core (cadena core0001..core0034 — las aplica core-migrate en el arranque).
...
jobhunt_core/       # Core Fase A COMPLETA 2026-07-24 (ensayo GATE A superado): API /v1 FastAPI (core-api :8003),
                    ...
                    #   delivery/runs/profiles, Alembic propio core0001..core0034, tests 706/706 (vía core-migrate)
```
