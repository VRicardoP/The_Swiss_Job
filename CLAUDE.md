...
# Migraciones core (cadena core0001..core0035 — las aplica core-migrate en el arranque).
...
jobhunt_core/       # Core Fase A COMPLETA 2026-07-24 (ensayo GATE A superado): API /v1 FastAPI (core-api :8003),
                    ...
                    #   delivery/runs/profiles, Alembic propio core0001..core0035, tests 715/715 (vía core-migrate)
```
