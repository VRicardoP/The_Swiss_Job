...
async def _run_pending_impl(limit: int, session_factory=None) -> dict[str, Any]:
    ...
    if session_factory is not None:
        return await _run_pending_with(session_factory, limit)
    async with task_session_factory() as factory:
        return await _run_pending_with(factory, limit)


async def _run_pending_with(session_factory, limit: int) -> dict[str, Any]:
