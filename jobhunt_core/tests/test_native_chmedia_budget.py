...
def test_each_request_has_absolute_timeout_and_late_timeout_preserves_prefix(monkeypatch):
    ...
    result, requests = fetch(pages=[{"items": [raw()]}, {"items": [raw(2)]}], monkeypatch=monkeypatch)
