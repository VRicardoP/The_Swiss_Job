...
def body(
    link, guid="", title="Lehrperson 80%", description="English teacher", category=""
):
...
@pytest.mark.parametrize(
    ...
    [
        ...
        "https://evil.example/stellen/a/b",
        "https://user@evil.example/stellen/a",
        "https://evil.example\\@www.zebis.ch/stellen/a",
...
def test_guid_fallback_and_legacy_content_not_generic_title_split():
    result = fetch(
        ...
        body(
            "https://[broken",
            "https://0.0.0.0:3000/stellen/role",
            title="English teacher at school",
            description="<p><strong>Academy</strong></p>English",
